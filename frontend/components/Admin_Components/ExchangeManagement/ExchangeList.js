...
function ExchangeList() {
    ...
    {/* Adjusted table with scrollable container */}
    <div className="bg-white shadow px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-x-scroll ">
            ...
            <table className="w-full table-auto">
                <thead>
                    <tr className="h-16 w-full text-sm leading-none text-gray-800">
                        ...
                        <th className="font-semibold text-left pl-12">Order Payload</th>
